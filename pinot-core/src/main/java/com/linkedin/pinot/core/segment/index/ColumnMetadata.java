...
import com.linkedin.pinot.core.segment.index.ColumnMetadata.Builder;
...
public class ColumnMetadata {
  ...
  public static ColumnMetadata fromPropertiesConfiguration(String column, PropertiesConfiguration config) {
    ...
    final boolean isAutoGenerated =
        config.getBoolean(V1Constants.MetadataKeys.Column
            .getKeyFor(column, V1Constants.MetadataKeys.Column.IS_AUTO_GENERATED), false);
    builder.setAutoGenerated(isAutoGenerated);

    Object defaultNullValue = null;
    String defaultNullValueKeyForColumn = V1Constants.MetadataKeys.Column
        .getKeyFor(column, V1Constants.MetadataKeys.Column.DEFAULT_NULL_VALUE);
    if(config.containsKey(defaultNullValueKeyForColumn)) {
      defaultNullValue = config.getProperty(defaultNullValueKeyForColumn);
    }
    builder.setDefaultNullValue(defaultNullValue);
  ...
  public static class Builder {
    ...
    public Builder setDefaultNullValue(Object defaultNullValue) {
    ...
    public ColumnMetadata build() {
      ...
      totalNumberOfEntries, defaultNullValue, isAutoGenerated);
    }
  ...
  private ColumnMetadata(String columnName, int cardinality, int totalRawDocs, int totalAggDocs, int totalDocs, DataType dataType, int bitsPerElement,
      ...
      int totalNumberOfEntries, Object defaultNullValue, boolean isAutoGenerated) {
